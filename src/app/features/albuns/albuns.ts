...
export class Albuns {
  ...
  fotos = signal<FotoPortfolio[]>([
    ...
    { id: 2, url: 'https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=400&q=80', categoria: 'casamentos', titulo: 'Sim de Ouro' },
    { id: 3, url: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=400&q=80', categoria: 'formaturas', titulo: 'A Grande Conquista' },
    { id: 4, url: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?auto=format&fit=crop&w=400&q=80', categoria: 'festas', titulo: 'Luzes da Noite' },
    { id: 5, url: 'https://images.unsplash.com/photo-1475809938514-043971a85c3c?auto=format&fit=crop&w=400&q=80', categoria: 'animais', titulo: 'Onça ' },
